...
use Afroware\JwTauth\Test\Stubs\LaravelUserStub;

class JwTGuardTest extends AbstractTestCase
{
    /**
     * @var \Afroware\JwTauth\JwT|\Mockery\MockInterface
     */
    protected $jwT;
    ...
    /**
     * @var \Afroware\JwTauth\JwTGuard|\Mockery\MockInterface
     */
    protected $guard;
    ...
    public function it_should_get_the_authenticated_user_if_a_valid_token_is_provided()
    {
        ...
        $this->jwT->shouldReceive('checkProvider')
                  ->once()
                  ->with('\Afroware\JwTauth\Test\Stubs\LaravelUserStub')
                  ->andReturn(true);

        $this->provider->shouldReceive('getModel')
                       ->once()
                       ->andReturn('\Afroware\JwTauth\Test\Stubs\LaravelUserStub');
     ...
     * @test
     * @group laravel-5.2
     * @expectedException \Afroware\JwTauth\Exceptions\UserNotDefinedException
